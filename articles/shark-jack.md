...
Étant donné qu'un utilisateur qui se branche physiquement à un réseau n'a pas besoin de mot de passe pour y accéder, il faut faire en sorte que les prises RJ45 soient le moins accessibles possible. Donc ne pas en mettre ailleurs que dans les bureaux.
